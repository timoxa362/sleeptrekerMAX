    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
      ...
      <Card className="border-l-4 border-[#8b5cf6]">
        <CardContent className="pt-4">
          <h2 className="text-sm font-medium text-slate-500 mb-1">Total Day Sleep</h2>
      ...
      <Card className="border-l-4 border-[#f97316]">
        <CardContent className="pt-4">
          <h2 className="text-sm font-medium text-slate-500 mb-1">Total Awake Time</h2>
          <div className="flex items-center space-x-2">
      ...
      <Card className="border-l-4 border-blue-500">
        <CardContent className="pt-4">
          <h2 className="text-sm font-medium text-slate-500 mb-1">Night Sleep Duration</h2>
          <div className="flex items-center space-x-2">
